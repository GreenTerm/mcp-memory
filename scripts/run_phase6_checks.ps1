...
$outputPath = Join-Path $artifactsDir "phase6_checks.txt"
...
@(
    "Running Phase 6 checks with $pythonCmd"
    "PYTHONPATH=$env:PYTHONPATH"
    ""
) | Set-Content -Encoding UTF8 $outputPath

& $pythonCmd -X utf8 -m unittest tests.test_api_server.ApiServerTests.test_ui_get_endpoints -v *>&1 |
