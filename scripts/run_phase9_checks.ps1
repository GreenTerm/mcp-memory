...
$outputPath = Join-Path $artifactsDir "phase9_checks.txt"
...
@(
    "Running Phase 9 checks with $pythonCmd"
    "PYTHONPATH=$env:PYTHONPATH"
    ""
) | Set-Content -Encoding UTF8 $outputPath

& $pythonCmd -X utf8 -m unittest tests.test_gui_home.GuiHomeTests.test_setup_wizard_renders_and_creates_project tests.test_gui_home.GuiHomeTests.test_setup_wizard_rejects_invalid_project_form -v *>&1 |
