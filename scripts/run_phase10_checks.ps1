...
$outputPath = Join-Path $artifactsDir "phase10_checks.txt"
...
@(
    "Running Phase 10 checks with $pythonCmd"
    "PYTHONPATH=$env:PYTHONPATH"
    ""
) | Set-Content -Encoding UTF8 $outputPath

& $pythonCmd -X utf8 -m unittest tests.test_api_server.ApiServerTests.test_ui_get_endpoints tests.test_gui_home.GuiHomeTests.test_setup_wizard_preserves_russian_language_links -v *>&1 |
