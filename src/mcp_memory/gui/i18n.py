...
PHRASE_TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "Open a local knowledge workspace.": "Откройте локальное рабочее пространство знаний.",
        "Projects stay local, schema-driven, searchable, and available through one DNS/path gateway for people and agents.": "Проекты остаются локальными, задаются схемой, доступны для поиска и открываются через единый DNS/path gateway для людей и агентов.",
        "Create the first local schema-driven workspace, then open it through the Home gateway when you are ready.": "Создайте первое локальное рабочее пространство со схемой, а затем откройте его через Home gateway.",
        "Start, open, and route each local workspace from one place.": "Запускайте, открывайте и маршрутизируйте локальные проекты из одного места.",
        "Local Runtime": "Локальный запуск",
        "Gateway": "Gateway",
        "Storage": "Хранилище",
        "Home": "Главная",
        "Knowledge": "Знания",
        ...
        "Local light-weigth reverse-engineering knowledge base.": "Локальная light-weigth база знаний для reverse engineering.",
        "Binaries": "Бинари",
...
PHRASE_TRANSLATIONS["ru"].update(
    {
        ...
        "Local light-weigth schema-backed knowledge base for people and agents.": "Локальная база знаний для людей и агентов, работающая от схемы.",
...
PHRASE_TRANSLATIONS["ru"].update(
    {
        ...
        "HTTP Endpoint": "HTTP адрес",
        "MCP Endpoint": "MCP адрес",
        "Copy MCP config": "Скопировать конфиг MCP",
        "Active Records": "Активные записи",
        "Archived": "Архив",
        "Types defined in this project schema.": "Типы, заданные схемой проекта.",
        "Records visible in default lists and search.": "Записи, видимые в списках и поиске.",
        "Records kept as history but hidden by default.": "Записи в архиве, скрытые по умолчанию.",
        "Typed links between records.": "Типизированные связи между записями.",
        "Generic changes waiting for confirmation.": "Изменения, ожидающие подтверждения.",
        "All entity types": "Все типы сущностей",
        "Search records": "Поиск по записям",
        "Title Field": "Поле заголовка",
        "Summary Field": "Поле описания",
        "Slug Field": "Slug-поле",
        "Required Fields": "Обязательные поля",
        "Actions": "Действия",
        "No description yet.": "Описание пока не задано.",
        "No entity types yet": "Типов сущностей пока нет",
        "Create an entity type to start adding records.": "Создайте тип сущности, чтобы добавлять записи.",
        "No recent updates yet": "Последних обновлений пока нет",
        "Created or updated records will appear here once the project has generic content.": "Созданные или обновленные записи появятся здесь, когда в проекте будут данные.",
        "Record Form": "Форма записи",
        "Save": "Сохранить",
        "fields are generated from schema.json.": "поля сгенерированы из schema.json.",
        "Required field.": "Обязательное поле.",
        "Optional field.": "Необязательное поле.",
        "Use a short single-line value.": "Введите короткое значение в одну строку.",
        "Use multi-line text.": "Введите многострочный текст.",
        "Use a numeric value.": "Введите числовое значение.",
        "Use a true/false checkbox.": "Используйте флажок да/нет.",
        "Choose one value from the schema-defined list.": "Выберите одно значение из списка схемы.",
        "Use tags separated by commas or new lines.": "Введите теги через запятую или с новой строки.",
        "Use valid JSON.": "Введите корректный JSON.",
        "Use a date/time value.": "Введите дату и время.",
        "Use a URL.": "Введите URL.",
        "Use a local file or directory path.": "Введите путь к локальному файлу или папке.",
        "Use a schema-defined value.": "Введите значение согласно схеме.",
        "friendly unique slug for human and agent links": "человекочитаемый уникальный slug для ссылок",
        "main display title": "основной заголовок записи",
        "short summary shown in lists and search results": "краткое описание в списках и поиске",
        "included in full-text search": "участвует в полнотекстовом поиске",
        "treated as tags": "обрабатывается как теги",
        "This field is used as": "Это поле используется как",
        "Show Payload JSON": "Показать payload JSON",
        "Payload": "Данные записи",
        "Add Evidence": "Добавить свидетельство",
        "No relations yet": "Связей пока нет",
        "Create relations through API or MCP.": "Создайте связи через API или MCP.",
        "No evidence yet": "Свидетельств пока нет",
        "Attach evidence from this page or through MCP.": "Прикрепите свидетельство на этой странице или через MCP.",
    }
)
